                ...
                <div class="row">
                    <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <p>Silakan Tranfer di Nomor ini<br>Atau Gopay </p>
                                <p>Silakan menunggu konfirmasi lebih lanjut melalui WhastApp</p>
                                <a href="{{url('index')}}" type="submit" class="btn btn-primary btn-lg btn-block" tabindex="4">
                                    Kembali
                                </a>
                            </div>
